// Maldives Monetary Authority exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/mma';
...
/** Latest rate for one pair, e.g. getRate('USD', 'MVR', { apiKey }). */
